...
only enhancing our ability to achieve our purpose. Also they define our high-performing culture and help us to deliver our ambitious growth strategy.
          ...
          <div class="col-md-8 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box">
              <div class="icon"><i class='fas fa-user-tie'></i></div>
                ...
                <button onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-green w3-large">Register</button>
  ...
  <div id="id01" class="w3-modal">
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
      ...
      <div class="w3-center">
        ...
        <img src="images/Screenshot.png" alt="Avatar" style="width:40%" class="w3-circle w3-margin-top">
      </div>

      <form class="w3-container" action="/action_page.php">
        <div class="w3-section">
          <label><b>Student Id</b></label>
          <asp:TextBox ID="TextBox5" runat="server" Height="32px" Width="531px" placeholder="Id" ></asp:TextBox>
          <label><b>Student Name</b></label>
            <asp:TextBox ID="TextBox11" runat="server" Height="32px" Width="531px" placeholder="Name" ></asp:TextBox>
            <label><b>Password</b></label>
          <asp:TextBox ID="TextBox6" runat="server" Height="32px" Width="527px" placeholder="Password" ></asp:TextBox>
           <button class="w3-button w3-block w3-green w3-section w3-padding" type="submit"><a href="dashboardstudent.aspx" target="_blank">Login</a></button>
      ...
      <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
        <button onclick="document.getElementById('id01').style.display='none'" type="button" class="w3-button w3-red">Cancel</button>
           <span class="w3-right w3-padding w3-hide-small"> <a href="register.aspx" target="_blank">New Register</a></span>
        <span class="w3-right w3-padding w3-hide-small"> <a href="forget.aspx" target="_blank">Forget password?</a></span>
      </div>
          ...
          <div class="col-md-8 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box">
              ...
              <button onclick="document.getElementById('id02').style.display='block'" class="w3-button w3-green w3-large">Register</button>
    ...
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
      ...
      <form class="w3-container" action="/action_page.php">
        <div class="w3-section">
         ...
         <asp:TextBox ID="TextBox9" runat="server" Height="32px" Width="550px" placeholder=" Id"></asp:TextBox>
          <label><b>Password</b></label>
         <asp:TextBox ID="TextBox10" runat="server" Height="32px" Width="550px" placeholder=" Password"></asp:TextBox>
          <button class="w3-button w3-block w3-green w3-section w3-padding" type="submit"><a href="dashboardmanager.aspx" target="_blank">Login</a></button>
          <input class="w3-check w3-margin-top" type="checkbox" checked="checked"> Remember me
        </div>
      </form>
      ...
      <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
        <button onclick="document.getElementById('id02').style.display='none'" type="button" class="w3-button w3-red">Cancel</button>
           <span class="w3-right w3-padding w3-hide-small"> <a href="registermanager.aspx" target="_blank">New Register</a></span>
        <span class="w3-right w3-padding w3-hide-small"> <a href="forgetmanager.aspx" target="_blank">Forget password</a></span>
      </div>
          ...
          <div class="col-md-8 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box">
              ...
              <button onclick="document.getElementById('id03').style.display='block'" class="w3-button w3-green w3-large">Register</button>
      ...
      <form class="w3-container" action="/action_page.php">
        <div class="w3-section">
          <label><b>Admin UserName</b></label>
            <asp:TextBox ID="TextBox7" runat="server" Height="32px" Width="550px" placeholder=" UserName"></asp:TextBox>
          <label><b>Password</b></label>
          <asp:TextBox ID="TextBox8" runat="server" Height="32px" Width="550px" placeholder=" UserName"></asp:TextBox>
          <button class="w3-button w3-block w3-green w3-section w3-padding" type="submit"><a href="dashboardadmin.aspx" target="_blank">Login</a></button>
          <input class="w3-check w3-margin-top" type="checkbox" checked="checked"> Remember me
        </div>
      </form>
  ...
  <div class="w3-container w3-padding-32" id="contact">
    ...
    <p>Lets get in touch and what about your questions and queries.</p>
      <div><p>
          <asp:TextBox ID="TextBox1" runat="server" Height="32px" Width="1386px" placeholder="Name" required="Name"></asp:TextBox>
      ...
      <p>
          <asp:TextBox ID="TextBox2" runat="server" Height="32px" Width="1386px" placeholder="Comment" required="Comment"></asp:TextBox>
      ...
      <p>
          <asp:TextBox ID="TextBox3" runat="server" Height="32px" Width="1386px" placeholder="Subject" required="Subject"></asp:TextBox>
      ...
      <p>
          <asp:TextBox ID="TextBox4" runat="server" Height="32px" Width="1386px" placeholder="Message" required="Message"></asp:TextBox>
        ...
        <asp:Button ID="Button1" runat="server" BackColor="Black" ForeColor="White" Height="41px" Text="SEND MESSAGE" Width="236px" OnClick="Button1_Click" />
    </form>
...
<footer class="w3-center w3-black w3-padding-16">
  <p>Powered by <a href="https://www.w3schools.com/w3css/default.asp" title="W3.CSS" target="_blank" class="w3-hover-text-green"><b>JK</b> Technology & Solutions</a></p>
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="#">KiranJedhe (CEO and Founder)</a>
      </div>
    </div>
</footer>
