                ...
                <div class="course-box">
                    ...
                    <div class="course">
                        <div class="box">
                            ...
                            <p>
                                <asp:Button ID="Button1" runat="server" BackColor="Black" ForeColor="White" Height="27px" Text="Edit Batch " Width="125px" OnClick="Button1_Click2" />
                            </p>
                        ...
                        <div class="box">
                            <h3>Web Developer</h3>
                            <p>75% - progress</p>
                             <asp:Button ID="Button2" runat="server" BackColor="Black" ForeColor="White" Height="27px" Text="Edit Batch " Width="125px" OnClick="Button2_Click" />
                            <i class="fab fa-css3-alt css"></i>
                        </div>
                        <div class="box">
                            <h3>SQL</h3>
                            <p>60% - progress</p>
                             <asp:Button ID="Button3" runat="server" BackColor="Black" ForeColor="White" Height="27px" Text="Edit Batch " Width="125px" OnClick="Button3_Click" />
                            <i class="fab fa-js-square js"></i>
                        </div>
                        <div class="box">
                            <h3>Java</h3>
                            <p>60% - progress</p>
                            <asp:Button ID="Button4" runat="server" BackColor="Black" ForeColor="White" Height="27px" Text="Edit Batch " Width="125px" OnClick="Button4_Click" />
                            <i class="fab fa-js-square js"></i>
                        </div>
                        <div class="box">
                            <h3>Dot Net</h3>
                            <p>60% - progress</p>
                             <asp:Button ID="Button5" runat="server" BackColor="Black" ForeColor="White" Height="27px" Text="Edit Batch " Width="125px" OnClick="Button5_Click" />
                            <i class="fab fa-js-square js"></i>
                        </div>
